...
def setMatrices():
    ...
    for i in range(numNodes):
        actionsdb[i, 0] = nodesdb[i, 1]
        transitionsdb[i, 0] = nodesdb[i, 1]
        rewarddb[i, 0] = nodesdb[i, 1]
        ...
        tmpLinksdb1 = linksdb[linksdb[:, 1] == nodesdb[i, 1]]
        tmpLinksdb2 = linksdb[linksdb[:, 2] == nodesdb[i, 1]]

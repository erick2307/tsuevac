...
def createVideo(filename, foldername, area="kochi",
                timeSimulation=30*60, meandeparture=15*60):
    # setup
    t0 = time.time()
...
def main():
    ...
    meandeparture = 15*60  # this is the actual evacuation behavior
    # (not necessary the trained behavior)
    createVideo(filename=filename, foldername=foldername, area=area,
                timeSimulation=timeSimulation, meandeparture=meandeparture)
    return
